...
- **Logging** — Implementado logger centralizado con Pino (custom levels agent/tool)
- **Autenticación** — BrainAuthMiddleware en endpoints SSE/MCP

#### Nuevo
- **Brain Frontend** — UI standalone en puerto 8082 para explorar memorias
