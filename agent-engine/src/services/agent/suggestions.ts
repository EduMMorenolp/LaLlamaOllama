			...
			messages: [
				{
					role: "system",
					content:
						'Genera 2-3 preguntas de seguimiento cortas (máx 8 palabras cada una) basadas en esta conversación. Responde SOLO con un array JSON de strings, nada más. Ejemplo: ["¿Puedes explicar más?", "¿Qué alternativas hay?"]',
				},
